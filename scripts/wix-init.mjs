...
for (const f of ['wix-elements-gen.mjs', 'wix-doctor.mjs', 'wix-scaffold.mjs', 'wix-app-scaffold.mjs', 'wix-build-element.mjs', 'wix-full.mjs', 'wix-check.mjs', 'wix-lint.mjs', 'wix-media.mjs', 'wix-media-lib.mjs', 'wix-cms.mjs', 'wix-cms-lib.mjs'])
...
if (!existsSync(pkgPath)) {
  ...
  set('wix:cms', 'node scripts/wix-cms.mjs');                  // CMS schema bridge (Data Collections + fields → committed map)
...
say(`   • See your CMS schema:   npm run wix:cms    (needs a Wix API key — see docs/wix-addon/CMS.md)`);
